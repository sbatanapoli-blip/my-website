...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "pool",
        "<init>",
        "(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/ByteWriteChannel;JZLl7/j;Lio/ktor/utils/io/pool/ObjectPool;)V",
        "Lg7/g0;",
        "flush",
...
# static fields
.field static final synthetic $$delegatedProperties:[Ld8/v;
...
.field private final masking$delegate:Lz7/c;

.field private final maxFrameSize$delegate:Lz7/c;
...
.method static constructor <clinit>()V
    ...
    .line 26
    .line 27
    invoke-virtual {v1, v2}, Lkotlin/jvm/internal/j0;->f(Lkotlin/jvm/internal/w;)Ld8/l;
    ...
    .line 39
    .line 40
    sput-object v2, Lio/ktor/websocket/RawWebSocketJvm;->$$delegatedProperties:[Ld8/v;
...
.method public constructor <init>(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/ByteWriteChannel;JZLl7/j;Lio/ktor/utils/io/pool/ObjectPool;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p6, v2}, Ll7/j;->get(Ll7/i;)Ll7/h;
    ...
    .line 3
    invoke-static {v4, v7, v7, v2, v7}, Lkotlinx/coroutines/channels/ChannelKt;->Channel$default(ILkotlinx/coroutines/channels/BufferOverflow;Lx7/b;ILjava/lang/Object;)Lkotlinx/coroutines/channels/Channel;
    ...
    .line 4
    invoke-interface {p6, v6}, Ll7/j;->plus(Ll7/j;)Ll7/j;
    ...
    invoke-interface {v1, v2}, Ll7/j;->plus(Ll7/j;)Ll7/j;

    move-result-object v1

    iput-object v1, p0, Lio/ktor/websocket/RawWebSocketJvm;->coroutineContext:Ll7/j;
    ...
    .line 7
    iput-object v2, p0, Lio/ktor/websocket/RawWebSocketJvm;->maxFrameSize$delegate:Lz7/c;
    ...
    .line 10
    iput-object v2, p0, Lio/ktor/websocket/RawWebSocketJvm;->masking$delegate:Lz7/c;

    .line 11
    new-instance v1, Lio/ktor/websocket/WebSocketWriter;

    invoke-virtual {p0}, Lio/ktor/websocket/RawWebSocketJvm;->getCoroutineContext()Ll7/j;

    move-result-object v2

    invoke-direct {v1, p2, v2, p5, p7}, Lio/ktor/websocket/WebSocketWriter;-><init>(Lio/ktor/utils/io/ByteWriteChannel;Ll7/j;ZLio/ktor/utils/io/pool/ObjectPool;)V
    ...
    invoke-direct {v0, p0, v7}, Lio/ktor/websocket/RawWebSocketJvm$1;-><init>(Lio/ktor/websocket/RawWebSocketJvm;Ll7/e;)V
    ...
    invoke-static/range {p1 .. p6}, Lkotlinx/coroutines/BuildersKt;->launch$default(Lkotlinx/coroutines/CoroutineScope;Ll7/j;Lkotlinx/coroutines/CoroutineStart;Lx7/c;ILjava/lang/Object;)Lkotlinx/coroutines/Job;
...
.method public synthetic constructor <init>(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/ByteWriteChannel;JZLl7/j;Lio/ktor/utils/io/pool/ObjectPool;ILkotlin/jvm/internal/j;)V
    .locals 8
    ...
    .line 16
    :goto_1
    invoke-direct/range {v0 .. v7}, Lio/ktor/websocket/RawWebSocketJvm;-><init>(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/ByteWriteChannel;JZLl7/j;Lio/ktor/utils/io/pool/ObjectPool;)V
...
.method public flush(Ll7/e;)Ljava/lang/Object;
    ...
    .line 2
    .line 3
    invoke-virtual {v0, p1}, Lio/ktor/websocket/WebSocketWriter;->flush(Ll7/e;)Ljava/lang/Object;
...
.method public getCoroutineContext()Ll7/j;
    ...
    .line 1
    iget-object v0, p0, Lio/ktor/websocket/RawWebSocketJvm;->coroutineContext:Ll7/j;
...
.method public getMasking()Z
    ...
    .line 1
    iget-object v0, p0, Lio/ktor/websocket/RawWebSocketJvm;->masking$delegate:Lz7/c;

    .line 2
    .line 3
    sget-object v1, Lio/ktor/websocket/RawWebSocketJvm;->$$delegatedProperties:[Ld8/v;
    ...
    .line 7
    .line 8
    invoke-interface {v0, p0, v1}, Lz7/b;->getValue(Ljava/lang/Object;Ld8/v;)Ljava/lang/Object;
...
.method public getMaxFrameSize()J
    ...
    .line 1
    iget-object v0, p0, Lio/ktor/websocket/RawWebSocketJvm;->maxFrameSize$delegate:Lz7/c;
...
.method public send(Lio/ktor/websocket/Frame;Ll7/e;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lio/ktor/websocket/WebSocketSession$DefaultImpls;->send(Lio/ktor/websocket/WebSocketSession;Lio/ktor/websocket/Frame;Ll7/e;)Ljava/lang/Object;
...
.method public setMasking(Z)V
    ...
    .line 12
    invoke-interface {v0, p0, v1, p1}, Lz7/c;->setValue(Ljava/lang/Object;Ld8/v;Ljava/lang/Object;)V
