...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "bodyBuilder",
        "append",
        "(Lio/ktor/client/request/forms/FormBuilder;Ljava/lang/String;Lio/ktor/http/Headers;Ljava/lang/Long;Lx7/b;)V",
        "filename",
        "Lio/ktor/http/ContentType;",
        "contentType",
        "(Lio/ktor/client/request/forms/FormBuilder;Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/ContentType;Ljava/lang/Long;Lx7/b;)V",
        "ktor-client-core"
    }
    k = 0x2
    mv = {
...
# direct methods
.method public static synthetic a(Lab/l;)Lg7/g0;
    .locals 0

    .line 1
    invoke-static {p0}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$7(Ljava/lang/Object;)Lg7/g0;
...
.method public static final append(Lio/ktor/client/request/forms/FormBuilder;Ljava/lang/String;Lio/ktor/http/Headers;Ljava/lang/Long;Lx7/b;)V
    .locals 3
    ...
    invoke-direct {v2, p4}, Lio/ktor/client/request/forms/FormDslKt$append$1;-><init>(Lx7/b;)V

    invoke-direct {v1, p3, v2}, Lio/ktor/client/request/forms/InputProvider;-><init>(Ljava/lang/Long;Lx7/a;)V
...
.method public static final append(Lio/ktor/client/request/forms/FormBuilder;Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/ContentType;Ljava/lang/Long;Lx7/b;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p5}, Lio/ktor/client/request/forms/FormDslKt$append$1;-><init>(Lx7/b;)V

    invoke-direct {v0, p4, v1}, Lio/ktor/client/request/forms/InputProvider;-><init>(Ljava/lang/Long;Lx7/a;)V
...
.method public static synthetic append$default(Lio/ktor/client/request/forms/FormBuilder;Ljava/lang/String;Lio/ktor/http/Headers;Ljava/lang/Long;Lx7/b;ILjava/lang/Object;)V
    .locals 1
    ...
    invoke-direct {v0, p4}, Lio/ktor/client/request/forms/FormDslKt$append$1;-><init>(Lx7/b;)V

    invoke-direct {p6, p3, v0}, Lio/ktor/client/request/forms/InputProvider;-><init>(Ljava/lang/Long;Lx7/a;)V
...
.method public static synthetic append$default(Lio/ktor/client/request/forms/FormBuilder;Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/ContentType;Ljava/lang/Long;Lx7/b;ILjava/lang/Object;)V
    .locals 1
    ...
    .line 4
    :cond_1
    invoke-static/range {p0 .. p5}, Lio/ktor/client/request/forms/FormDslKt;->append(Lio/ktor/client/request/forms/FormBuilder;Ljava/lang/String;Ljava/lang/String;Lio/ktor/http/ContentType;Ljava/lang/Long;Lx7/b;)V

    return-void
.end method

.method public static synthetic b()Lg7/g0;
    .locals 1

    .line 1
    invoke-static {}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$1()Lg7/g0;
...
.method public static synthetic c()Lg7/g0;
    ...
    .line 1
    invoke-static {}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$2()Lg7/g0;
...
.method public static synthetic d()Lg7/g0;
    .locals 1

    .line 1
    invoke-static {}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$3()Lg7/g0;
...
.method public static synthetic e()Lg7/g0;
    .locals 1

    .line 1
    invoke-static {}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$8()Lg7/g0;
...
.method public static synthetic f()Lg7/g0;
    .locals 1

    .line 1
    invoke-static {}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$5()Lg7/g0;
...
.method public static final formData(Lx7/b;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final varargs formData([Lio/ktor/client/request/forms/FormPart;)Ljava/util/List;
    ...
    invoke-direct {v7, v2, v9, v8}, Lio/ktor/http/HeadersBuilder;-><init>(IILkotlin/jvm/internal/j;)V
    ...
    invoke-direct {v5, v8}, Lab/m;-><init>(I)V

    invoke-virtual {v7}, Lio/ktor/http/HeadersBuilder;->build()Lio/ktor/http/Headers;

    move-result-object v7

    invoke-direct {v4, v6, v5, v7}, Lio/ktor/http/content/PartData$FormItem;-><init>(Ljava/lang/String;Lx7/a;Lio/ktor/http/Headers;)V
    ...
    invoke-direct {v6, v8}, Lab/m;-><init>(I)V

    invoke-virtual {v7}, Lio/ktor/http/HeadersBuilder;->build()Lio/ktor/http/Headers;

    move-result-object v7

    invoke-direct {v4, v5, v6, v7}, Lio/ktor/http/content/PartData$FormItem;-><init>(Ljava/lang/String;Lx7/a;Lio/ktor/http/Headers;)V
    ...
    .line 13
    new-instance v5, Lio/ktor/client/request/forms/a;

    invoke-direct {v5, v6}, Lio/ktor/client/request/forms/a;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v4, v5, v6, v7}, Lio/ktor/http/content/PartData$BinaryItem;-><init>(Lx7/a;Lx7/a;Lio/ktor/http/Headers;)V

    goto/16 :goto_1

    .line 15
    :cond_3
    instance-of v4, v6, Lab/l;
    ...
    invoke-static {v6}, Lio/ktor/utils/io/core/ByteReadPacketKt;->getRemaining(Lab/l;)J
    ...
    .line 18
    new-instance v5, Lio/ktor/client/request/forms/b;

    const/4 v8, 0x0

    invoke-direct {v5, v6, v8}, Lio/ktor/client/request/forms/b;-><init>(Lab/l;I)V

    new-instance v8, Lio/ktor/client/request/forms/b;

    const/4 v9, 0x1

    invoke-direct {v8, v6, v9}, Lio/ktor/client/request/forms/b;-><init>(Lab/l;I)V
    ...
    invoke-direct {v4, v5, v8, v6}, Lio/ktor/http/content/PartData$BinaryItem;-><init>(Lx7/a;Lx7/a;Lio/ktor/http/Headers;)V
    ...
    invoke-virtual {v6}, Lio/ktor/client/request/forms/InputProvider;->getBlock()Lx7/a;
    ...
    invoke-virtual {v6}, Lio/ktor/client/request/forms/ChannelProvider;->getBlock()Lx7/a;
    ...
    invoke-direct {v4, v5, v6}, Lio/ktor/http/content/PartData$BinaryChannelItem;-><init>(Lx7/a;Lio/ktor/http/Headers;)V
    ...
    .line 31
    invoke-static {v6, v0}, Lio/github/jan/supabase/network/c;->h(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method private static final formData$lambda$9$lambda$1()Lg7/g0;
    .locals 1
...
.method private static final formData$lambda$9$lambda$2()Lg7/g0;
    .locals 1
...
.method private static final formData$lambda$9$lambda$3()Lg7/g0;
    .locals 1
...
.method private static final formData$lambda$9$lambda$4(Ljava/lang/Object;)Lab/l;
    .locals 3
    ...
    .line 6
    invoke-static {p0, v2, v2, v0, v1}, Lio/ktor/utils/io/core/ByteReadPacketKt;->ByteReadPacket$default([BIIILjava/lang/Object;)Lab/l;
...
.method private static final formData$lambda$9$lambda$5()Lg7/g0;
    .locals 1
...
.method private static final formData$lambda$9$lambda$6(Ljava/lang/Object;)Lab/l;
    .locals 0
    ...
    .line 2
    .line 3
    invoke-static {p0}, Lio/ktor/utils/io/core/ByteReadPacketKt;->copy(Lab/l;)Lab/l;
...
.method private static final formData$lambda$9$lambda$7(Ljava/lang/Object;)Lg7/g0;
    .locals 0
...
.method private static final formData$lambda$9$lambda$8()Lg7/g0;
    .locals 1
...
.method public static synthetic g(Ljava/lang/Object;)Lab/l;
    .locals 0

    .line 1
    invoke-static {p0}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$4(Ljava/lang/Object;)Lab/l;
...
.method public static synthetic h(Lab/l;)Lab/l;
    .locals 0

    .line 1
    invoke-static {p0}, Lio/ktor/client/request/forms/FormDslKt;->formData$lambda$9$lambda$6(Ljava/lang/Object;)Lab/l;
