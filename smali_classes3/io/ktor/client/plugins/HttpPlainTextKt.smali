...
.method public static final Charsets(Lio/ktor/client/HttpClientConfig;Lx7/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 12
    .line 13
    invoke-virtual {p0, v0, p1}, Lio/ktor/client/HttpClientConfig;->install(Lio/ktor/client/plugins/HttpClientPlugin;Lx7/b;)V
...
.method private static final HttpPlainText$lambda$6(Lio/ktor/client/plugins/api/ClientPluginBuilder;)Lg7/g0;
    .locals 12
    ...
    .line 16
    invoke-static {v0}, Lh7/e0;->k0(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 318
    .line 319
    invoke-direct {v2, v3, v4, v5}, Lio/ktor/client/plugins/HttpPlainTextKt$HttpPlainText$2$1;-><init>(Ljava/lang/String;Ljava/nio/charset/Charset;Ll7/e;)V
    ...
    .line 326
    .line 327
    invoke-direct {v0, v1, v5}, Lio/ktor/client/plugins/HttpPlainTextKt$HttpPlainText$2$2;-><init>(Ljava/nio/charset/Charset;Ll7/e;)V

    .line 328
    .line 329
    .line 330
    invoke-virtual {p0, v0}, Lio/ktor/client/plugins/api/ClientPluginBuilder;->transformResponseBody(Lx7/f;)V
...
.method private static final HttpPlainText$lambda$6$addCharsetHeaders(Ljava/lang/String;Lio/ktor/client/request/HttpRequestBuilder;)V
    ...
    .line 23
    .line 24
    invoke-static {v2, p0, v3}, Lio/github/jan/supabase/network/c;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private static final HttpPlainText$lambda$6$read(Ljava/nio/charset/Charset;Lio/ktor/client/call/HttpClientCall;Lab/l;)Ljava/lang/String;
    .locals 3
    ...
    .line 51
    invoke-static {p2, p0, v1, p1, v0}, Lio/ktor/utils/io/core/StringsKt;->readText$default(Lab/l;Ljava/nio/charset/Charset;IILjava/lang/Object;)Ljava/lang/String;
...
.method private static final HttpPlainText$lambda$6$wrapContent(Ljava/nio/charset/Charset;Lio/ktor/client/request/HttpRequestBuilder;Ljava/lang/String;Lio/ktor/http/ContentType;)Lio/ktor/http/content/OutgoingContent;
    ...
    .line 62
    invoke-direct/range {v1 .. v6}, Lio/ktor/http/content/TextContent;-><init>(Ljava/lang/String;Lio/ktor/http/ContentType;Lio/ktor/http/HttpStatusCode;ILkotlin/jvm/internal/j;)V
...
.method public static synthetic a(Lio/ktor/client/plugins/api/ClientPluginBuilder;)Lg7/g0;
    ...
    .line 1
    invoke-static {p0}, Lio/ktor/client/plugins/HttpPlainTextKt;->HttpPlainText$lambda$6(Lio/ktor/client/plugins/api/ClientPluginBuilder;)Lg7/g0;
...
.method public static final synthetic access$HttpPlainText$lambda$6$read(Ljava/nio/charset/Charset;Lio/ktor/client/call/HttpClientCall;Lab/l;)Ljava/lang/String;
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lio/ktor/client/plugins/HttpPlainTextKt;->HttpPlainText$lambda$6$read(Ljava/nio/charset/Charset;Lio/ktor/client/call/HttpClientCall;Lab/l;)Ljava/lang/String;
