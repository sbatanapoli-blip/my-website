...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "block",
        "config",
        "(Lx7/b;)Lio/ktor/client/HttpClient;",
        "close",
        "()V",
        "",
        "toString",
...
.method public constructor <init>(Lio/ktor/client/engine/HttpClientEngine;Lio/ktor/client/HttpClientConfig;)V
    ...
    invoke-interface {v2, v1}, Ll7/j;->plus(Ll7/j;)Ll7/j;

    move-result-object v2

    iput-object v2, p0, Lio/ktor/client/HttpClient;->coroutineContext:Ll7/j;
    ...
    .line 16
    new-instance v3, Lio/github/jan/supabase/postgrest/executor/a;

    const/4 v6, 0x4

    invoke-direct {v3, p0, v6}, Lio/github/jan/supabase/postgrest/executor/a;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v1, v3}, Lkotlinx/coroutines/Job;->invokeOnCompletion(Lx7/b;)Lkotlinx/coroutines/DisposableHandle;
    ...
    invoke-direct {v1, p0, v4}, Lio/ktor/client/HttpClient$2;-><init>(Lio/ktor/client/HttpClient;Ll7/e;)V

    invoke-virtual {v5, p1, v1}, Lio/ktor/util/pipeline/Pipeline;->intercept(Lio/ktor/util/pipeline/PipelinePhase;Lx7/d;)V
    ...
    invoke-static {v0, p1, v4, v1, v4}, Lio/ktor/client/HttpClientConfig;->install$default(Lio/ktor/client/HttpClientConfig;Lio/ktor/client/plugins/HttpClientPlugin;Lx7/b;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v3, p1}, Lio/ktor/client/HttpClientConfig;->install(Ljava/lang/String;Lx7/b;)V
    ...
    invoke-direct {p2, p0, v4}, Lio/ktor/client/HttpClient$4;-><init>(Lio/ktor/client/HttpClient;Ll7/e;)V

    invoke-virtual {v2, p1, p2}, Lio/ktor/util/pipeline/Pipeline;->intercept(Lio/ktor/util/pipeline/PipelinePhase;Lx7/d;)V
...
.method public static synthetic O(Lio/ktor/client/HttpClient;Ljava/lang/Throwable;)Lg7/g0;
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lio/ktor/client/HttpClient;->_init_$lambda$0(Lio/ktor/client/HttpClient;Ljava/lang/Throwable;)Lg7/g0;
...
.method public static synthetic R(Lio/ktor/client/HttpClient;)Lg7/g0;
    .locals 0

    .line 1
    invoke-static {p0}, Lio/ktor/client/HttpClient;->lambda$2$lambda$1(Lio/ktor/client/HttpClient;)Lg7/g0;
...
.method private static final _init_$lambda$0(Lio/ktor/client/HttpClient;Ljava/lang/Throwable;)Lg7/g0;
    .locals 1
...
.method private static final lambda$2$lambda$1(Lio/ktor/client/HttpClient;)Lg7/g0;
    .locals 1
...
.method public final config(Lx7/b;)Lio/ktor/client/HttpClient;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final execute$ktor_client_core(Lio/ktor/client/request/HttpRequestBuilder;Ll7/e;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 21
    .line 22
    invoke-direct {v0, p0, p2}, Lio/ktor/client/HttpClient$execute$1;-><init>(Lio/ktor/client/HttpClient;Ll7/e;)V
    ...
    .line 67
    .line 68
    invoke-virtual {p2, p1, v2, v0}, Lio/ktor/util/pipeline/Pipeline;->execute(Ljava/lang/Object;Ljava/lang/Object;Ll7/e;)Ljava/lang/Object;
...
.method public getCoroutineContext()Ll7/j;
    ...
    .line 1
    iget-object v0, p0, Lio/ktor/client/HttpClient;->coroutineContext:Ll7/j;
