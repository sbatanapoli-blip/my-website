...
# direct methods
.method public static A(Lj$/time/chrono/i;)J
    .locals 4

    .line 553
    invoke-interface {p0}, Lj$/time/chrono/i;->f()Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 554
    invoke-interface {p0}, Lj$/time/chrono/i;->b()Lj$/time/LocalTime;
...
.method public static B(Lj$/util/e0;Ljava/util/function/Consumer;)Z
    .locals 2
    ...
    invoke-interface {p0, p1}, Lj$/util/e0;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    .line 807
    :cond_0
    sget-boolean v0, Lj$/util/d1;->a:Z
    ...
    invoke-direct {v0, p1, v1}, Lj$/util/o;-><init>(Ljava/util/function/Consumer;I)V

    invoke-interface {p0, v0}, Lj$/util/e0;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    invoke-static {p0, p1}, Lj$/util/d1;->a(Ljava/lang/Class;Ljava/lang/String;)V
...
.method public static C(Lj$/util/h0;Ljava/util/function/Consumer;)Z
    .locals 2
    ...
    invoke-interface {p0, p1}, Lj$/util/h0;->tryAdvance(Ljava/util/function/IntConsumer;)Z
    ...
    invoke-direct {v0, p1, v1}, Lj$/util/s;-><init>(Ljava/util/function/Consumer;I)V

    invoke-interface {p0, v0}, Lj$/util/h0;->tryAdvance(Ljava/util/function/IntConsumer;)Z
...
.method public static D(Lj$/util/k0;Ljava/util/function/Consumer;)Z
    .locals 2
    ...
    invoke-interface {p0, p1}, Lj$/util/k0;->tryAdvance(Ljava/util/function/LongConsumer;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/k0;->tryAdvance(Ljava/util/function/LongConsumer;)Z
...
.method public static E(Ljava/util/Optional;)Lj$/util/Optional;
    .locals 1
...
.method public static F(Ljava/util/OptionalDouble;)Lj$/util/l;
    .locals 2
    ...
    .line 113
    new-instance p0, Lj$/util/l;

    invoke-direct {p0, v0, v1}, Lj$/util/l;-><init>(D)V
...
.method public static G(Ljava/util/OptionalInt;)Lj$/util/m;
    .locals 1
...
.method public static H(Ljava/util/OptionalLong;)Lj$/util/n;
    .locals 2
    ...
    .line 113
    new-instance p0, Lj$/util/n;

    invoke-direct {p0, v0, v1}, Lj$/util/n;-><init>(J)V

    return-object p0

    .line 68
    :cond_1
    sget-object p0, Lj$/util/n;->c:Lj$/util/n;
...
.method public static J(Lj$/util/l;)Ljava/util/OptionalDouble;
    .locals 2
...
.method public static K(Lj$/util/m;)Ljava/util/OptionalInt;
    .locals 1
...
.method public static L(Lj$/util/n;)Ljava/util/OptionalLong;
    .locals 2
...
.method public static M(Ljava/util/Collection;Ljava/util/function/Consumer;)V
    .locals 1
...
.method public static N(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/l;
    .locals 1
...
.method public static W(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    .locals 4
...
.method public static X(Ljava/lang/String;)Lj$/time/chrono/l;
    .locals 4
    ...
    invoke-static {v0, v2}, Lj$/time/chrono/a;->l(Lj$/time/chrono/l;Ljava/lang/String;)Lj$/time/chrono/l;
    ...
    invoke-static {v2, v3}, Lj$/time/chrono/a;->l(Lj$/time/chrono/l;Ljava/lang/String;)Lj$/time/chrono/l;
    ...
    invoke-static {v0, v1}, Lj$/time/chrono/a;->l(Lj$/time/chrono/l;Ljava/lang/String;)Lj$/time/chrono/l;
...
.method public static synthetic Y(Ljava/util/Map;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 1
...
.method public static Z(Ljava/util/Collection;)Lj$/util/Spliterator;
    .locals 1
    ...
    invoke-direct {v0, p0, p0}, Lj$/util/b0;-><init>(Ljava/util/SortedSet;Ljava/util/Collection;)V
...
.method public static b(Ljava/util/function/Predicate;Ljava/util/function/Predicate;)Lj$/util/function/f;
    .locals 2
...
.method public static c(Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Lj$/time/format/s;
    .locals 2
...
.method public static h(Lj$/time/chrono/d;Lj$/time/chrono/d;)I
    .locals 2

    .line 507
    invoke-interface {p0}, Lj$/time/chrono/d;->f()Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 509
    invoke-interface {p0}, Lj$/time/chrono/d;->b()Lj$/time/LocalTime;
...
.method public static i(Lj$/time/chrono/i;Lj$/time/chrono/i;)I
    .locals 4

    .line 577
    invoke-interface {p0}, Lj$/time/chrono/i;->K()J

    move-result-wide v0

    invoke-interface {p1}, Lj$/time/chrono/i;->K()J
    ...
    .line 581
    invoke-interface {p0}, Lj$/time/chrono/i;->p()Lj$/time/chrono/d;

    move-result-object v0

    invoke-interface {p1}, Lj$/time/chrono/i;->p()Lj$/time/chrono/d;

    move-result-object v1

    invoke-interface {v0, v1}, Lj$/time/chrono/d;->F(Lj$/time/chrono/d;)I
    ...
    .line 583
    invoke-interface {p0}, Lj$/time/chrono/i;->A()Lj$/time/v;
    ...
    invoke-interface {p1}, Lj$/time/chrono/i;->A()Lj$/time/v;
    ...
    .line 585
    invoke-interface {p0}, Lj$/time/chrono/i;->a()Lj$/time/chrono/l;

    move-result-object p0

    invoke-interface {p1}, Lj$/time/chrono/i;->a()Lj$/time/chrono/l;
...
.method public static k(Lj$/util/e0;Ljava/util/function/Consumer;)V
    .locals 2
    ...
    invoke-interface {p0, p1}, Lj$/util/e0;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/e0;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
...
.method public static l(Lj$/util/h0;Ljava/util/function/Consumer;)V
    .locals 2
    ...
    invoke-interface {p0, p1}, Lj$/util/h0;->forEachRemaining(Ljava/util/function/IntConsumer;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/h0;->forEachRemaining(Ljava/util/function/IntConsumer;)V
...
.method public static m(Lj$/util/k0;Ljava/util/function/Consumer;)V
    .locals 2
    ...
    invoke-interface {p0, p1}, Lj$/util/k0;->forEachRemaining(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/k0;->forEachRemaining(Ljava/util/function/LongConsumer;)V
...
.method public static n(Lj$/time/chrono/i;Lj$/time/temporal/p;)I
    .locals 2
...
.method public static o(Lj$/time/chrono/m;Lj$/time/temporal/p;)I
    .locals 1
...
.method public static q(Lj$/time/chrono/m;Lj$/time/temporal/p;)J
    .locals 1
...
.method public static s(Lj$/time/chrono/ChronoLocalDate;Lj$/time/temporal/p;)Z
    .locals 1
...
.method public static t(Lj$/time/chrono/m;Lj$/time/temporal/p;)Z
    .locals 1
...
.method public static u(Ljava/util/function/Predicate;Ljava/util/function/Predicate;)Lj$/util/function/f;
    .locals 2
...
.method public static w(Lj$/time/chrono/d;Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    .locals 1
...
.method public static x(Lj$/time/chrono/i;Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    .locals 1
...
.method public static y(Lj$/time/chrono/m;Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    .locals 1
...
.method public static z(Lj$/time/chrono/d;Lj$/time/ZoneOffset;)J
    .locals 4
