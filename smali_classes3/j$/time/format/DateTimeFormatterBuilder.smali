...
.method static constructor <clinit>()V
    ...
    .line 158
    sput-object v0, Lj$/time/format/DateTimeFormatterBuilder;->f:Lj$/time/d;
...
.method public final e(Lj$/time/temporal/a;Ljava/util/Map;)V
    ...
    invoke-direct {v1, p1, p2, v0}, Lj$/time/format/n;-><init>(Lj$/time/temporal/p;Lj$/time/format/x;Lj$/time/format/a;)V
...
.method public final f(Lj$/time/format/h;)V
    ...
    .line 0
    iget-object v2, p1, Lj$/time/format/h;->d:Lj$/time/format/w;
...
.method public final g(Lj$/time/temporal/p;I)V
    ...
    invoke-direct {v0, p1, p2, p2, v1}, Lj$/time/format/h;-><init>(Lj$/time/temporal/p;IILj$/time/format/w;)V

    .line 468
    invoke-virtual {p0, v0}, Lj$/time/format/DateTimeFormatterBuilder;->f(Lj$/time/format/h;)V
...
.method public final h(Lj$/time/temporal/p;IILj$/time/format/w;)V
    .locals 2
    ...
    .line 506
    invoke-virtual {p0, p1, p3}, Lj$/time/format/DateTimeFormatterBuilder;->g(Lj$/time/temporal/p;I)V
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Lj$/time/format/h;-><init>(Lj$/time/temporal/p;IILj$/time/format/w;)V
...
.method public final k(Lj$/time/format/v;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1, p2}, Lj$/time/format/DateTimeFormatterBuilder;->l(Ljava/util/Locale;Lj$/time/format/v;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
...
.method public final l(Ljava/util/Locale;Lj$/time/format/v;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
    .locals 3
    ...
    .line 2251
    invoke-virtual {p0}, Lj$/time/format/DateTimeFormatterBuilder;->i()V
    ...
    invoke-direct {v1, v0, p1, p2, p3}, Lj$/time/format/DateTimeFormatter;-><init>(Lj$/time/format/d;Ljava/util/Locale;Lj$/time/format/v;Lj$/time/chrono/l;)V
...
.method public toFormatter()Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lj$/time/format/DateTimeFormatterBuilder;->l(Ljava/util/Locale;Lj$/time/format/v;Lj$/time/chrono/l;)Lj$/time/format/DateTimeFormatter;
