...
# direct methods
.method public constructor <init>(Lj$/time/Instant;Lj$/time/format/DateTimeFormatter;)V
    .locals 9
    ...
    invoke-virtual {p1, v1}, Lj$/time/Instant;->D(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v2}, Lj$/time/Instant;->D(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lj$/time/v;
    ...
    invoke-virtual {p1, v5}, Lj$/time/Instant;->e(Lj$/time/temporal/p;)Z
    ...
    .line 164
    invoke-interface {v3, p1}, Lj$/time/chrono/l;->y(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-virtual {p1, v7}, Lj$/time/Instant;->e(Lj$/time/temporal/p;)Z
    ...
    invoke-direct {v0, v4, p1, v3, v2}, Lj$/time/format/p;-><init>(Lj$/time/chrono/ChronoLocalDate;Lj$/time/Instant;Lj$/time/chrono/l;Lj$/time/v;)V
...
.method public final a(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    iget-object v1, p0, Lj$/time/format/q;->a:Lj$/time/temporal/TemporalAccessor;

    if-lez v0, :cond_0

    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->e(Lj$/time/temporal/p;)Z
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->B(Lj$/time/temporal/p;)J
...
.method public final toString()Ljava/lang/String;
    ...
    .line 319
    iget-object v0, p0, Lj$/time/format/q;->a:Lj$/time/temporal/TemporalAccessor;
