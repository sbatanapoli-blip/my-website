...
.method public final synthetic allMatch(Ljava/util/function/IntPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->o()Z
...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asDoubleStream()Lj$/util/stream/b0;
...
.method public final synthetic asLongStream()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asLongStream()Lj$/util/stream/k1;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->average()Lj$/util/l;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findAny()Lj$/util/m;

    move-result-object v0

    invoke-static {v0}, Lj$/com/android/tools/r8/a;->K(Lj$/util/m;)Ljava/util/OptionalInt;
...
.method public final synthetic findFirst()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findFirst()Lj$/util/m;
...
.method public final flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    .line 90
    iput-object p1, v1, Lj$/util/stream/j0;->a:Ljava/util/function/IntFunction;

    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/IntStream;->q(Lj$/util/stream/j0;)Lj$/util/stream/IntStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/v;
    ...
    iget-object v0, v0, Lj$/util/t;->a:Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-direct {v1, v0}, Lj$/util/u;-><init>(Lj$/util/v;)V
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->g()Lj$/util/stream/b0;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->l()Lj$/util/stream/k1;
...
.method public final synthetic max()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->max()Lj$/util/m;
...
.method public final synthetic min()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->min()Lj$/util/m;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->reduce(Ljava/util/function/IntBinaryOperator;)Lj$/util/m;

    move-result-object p1

    invoke-static {p1}, Lj$/com/android/tools/r8/a;->K(Lj$/util/m;)Ljava/util/OptionalInt;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfInt;
    ...
    invoke-static {v0}, Lj$/util/g0;->a(Lj$/util/h0;)Ljava/util/Spliterator$OfInt;
