...
.method public final C(Lj$/util/function/g;)Lj$/util/stream/IntStream;
    .locals 3
    ...
    invoke-direct {v0, p0, v1, p1, v2}, Lj$/util/stream/s0;-><init>(Lj$/util/stream/a;ILjava/lang/Object;I)V
...
.method public final J0(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/e2;
    ...
    .line 109
    invoke-static {p1, p2, p3, p4}, Lj$/util/stream/t3;->b0(Lj$/util/stream/t3;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/e2;
...
.method public final allMatch(Ljava/util/function/Predicate;)Z
    ...
    invoke-static {v0, p1}, Lj$/util/stream/t3;->B0(Lj$/util/stream/r1;Ljava/util/function/Predicate;)Lj$/time/format/s;

    move-result-object p1

    invoke-virtual {p0, p1}, Lj$/util/stream/a;->H0(Lj$/util/stream/c8;)Ljava/lang/Object;
...
.method public final dropWhile(Ljava/util/function/Predicate;)Lj$/util/stream/Stream;
    ...
    invoke-direct {v0, p0, v1, p1, v2}, Lj$/util/stream/f8;-><init>(Lj$/util/stream/b5;ILjava/util/function/Predicate;I)V
...
.method public forEach(Ljava/util/function/Consumer;)V
    ...
    invoke-direct {v0, p1, v1}, Lj$/util/stream/n0;-><init>(Ljava/util/function/Consumer;Z)V
...
.method public final h(Lj$/util/stream/h;)Ljava/lang/Object;
    .locals 9
    ...
    .line 0
    iget-object v0, p1, Lj$/util/stream/h;->a:Ljava/util/stream/Collector;
    ...
    .line 24
    instance-of v5, v4, Lj$/util/stream/g;
    ...
    .line 0
    :cond_1
    sget-object v5, Lj$/util/stream/g;->CONCURRENT:Lj$/util/stream/g;
    ...
    :cond_2
    sget-object v5, Lj$/util/stream/g;->UNORDERED:Lj$/util/stream/g;
    ...
    sget-object v4, Lj$/util/stream/g;->CONCURRENT:Lj$/util/stream/g;
    ...
    sget-object v4, Lj$/util/stream/g;->UNORDERED:Lj$/util/stream/g;

    goto :goto_3

    :cond_7
    sget-object v4, Lj$/util/stream/g;->IDENTITY_FINISH:Lj$/util/stream/g;
    ...
    invoke-virtual {v0, v3}, Lj$/util/stream/w6;->o(I)Z
    ...
    .line 0
    iget-object v3, p1, Lj$/util/stream/h;->a:Ljava/util/stream/Collector;
    ...
    invoke-direct {v4, v5, v3, v0}, Lj$/time/format/s;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {p0, v4}, Lj$/util/stream/b5;->forEach(Ljava/util/function/Consumer;)V
    ...
    sget-object v4, Lj$/util/stream/x6;->REFERENCE:Lj$/util/stream/x6;

    move-object v8, p1

    invoke-direct/range {v3 .. v8}, Lj$/util/stream/f4;-><init>(Lj$/util/stream/x6;Ljava/util/function/BinaryOperator;Ljava/util/function/BiConsumer;Ljava/util/function/Supplier;Lj$/util/stream/h;)V

    .line 578
    invoke-virtual {p0, v3}, Lj$/util/stream/a;->H0(Lj$/util/stream/c8;)Ljava/lang/Object;

    move-result-object v0

    .line 0
    :goto_a
    iget-object p1, v8, Lj$/util/stream/h;->a:Ljava/util/stream/Collector;
...
.method public final limit(J)Lj$/util/stream/Stream;
    ...
    .line 470
    invoke-static {p0, v0, v1, p1, p2}, Lj$/util/stream/t3;->C0(Lj$/util/stream/b5;JJ)Lj$/util/stream/l5;
...
.method public final mapToDouble(Ljava/util/function/ToDoubleFunction;)Lj$/util/stream/b0;
    .locals 3
...
.method public final mapToLong(Ljava/util/function/ToLongFunction;)Lj$/util/stream/k1;
    .locals 3
...
.method public final r(Lj$/util/function/g;)Lj$/util/stream/k1;
    .locals 3
...
.method public final skip(J)Lj$/util/stream/Stream;
    ...
    .line 480
    invoke-static {p0, p1, p2, v0, v1}, Lj$/util/stream/t3;->C0(Lj$/util/stream/b5;JJ)Lj$/util/stream/l5;
...
.method public final toArray(Ljava/util/function/IntFunction;)[Ljava/lang/Object;
    ...
    .line 517
    invoke-virtual {p0, p1}, Lj$/util/stream/a;->I0(Ljava/util/function/IntFunction;)Lj$/util/stream/e2;

    move-result-object v0

    invoke-static {v0, p1}, Lj$/util/stream/t3;->n0(Lj$/util/stream/e2;Ljava/util/function/IntFunction;)Lj$/util/stream/e2;
...
.method public final z(Lj$/util/function/g;)Lj$/util/stream/b0;
    .locals 3
