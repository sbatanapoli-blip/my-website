...
.method public synthetic constructor <init>(Ljava/util/stream/LongStream;)V
    ...
    iput-object p1, p0, Lj$/util/stream/i1;->a:Ljava/util/stream/LongStream;

    return-void
.end method

.method public static synthetic f(Ljava/util/stream/LongStream;)Lj$/util/stream/k1;
    .locals 1
    ...
    iget-object p0, p0, Lj$/util/stream/j1;->a:Lj$/util/stream/k1;
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/i1;-><init>(Ljava/util/stream/LongStream;)V
...
.method public final synthetic A()Lj$/util/stream/IntStream;
    ...
    .line 0
    iget-object v1, p0, Lj$/util/stream/i1;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic a()Lj$/util/stream/k1;
    .locals 2
    ...
    invoke-static {v0}, Lj$/util/stream/i1;->f(Ljava/util/stream/LongStream;)Lj$/util/stream/k1;
...
.method public final synthetic asDoubleStream()Lj$/util/stream/b0;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/i1;->a:Ljava/util/stream/LongStream;

    invoke-interface {v0}, Ljava/util/stream/LongStream;->asDoubleStream()Ljava/util/stream/DoubleStream;

    move-result-object v0

    invoke-static {v0}, Lj$/util/stream/z;->f(Ljava/util/stream/DoubleStream;)Lj$/util/stream/b0;
...
.method public final synthetic average()Lj$/util/l;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->F(Ljava/util/OptionalDouble;)Lj$/util/l;
...
.method public final synthetic b()Lj$/util/stream/k1;
    .locals 2
...
.method public final synthetic boxed()Lj$/util/stream/Stream;
    ...
    invoke-static {v0}, Lj$/util/stream/u6;->f(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic c()Lj$/util/stream/k1;
    .locals 2
...
.method public final d(Lj$/util/function/g;)Lj$/util/stream/k1;
    ...
    invoke-static {p1}, Lj$/util/stream/i1;->f(Ljava/util/stream/LongStream;)Lj$/util/stream/k1;
...
.method public final synthetic distinct()Lj$/util/stream/k1;
    .locals 1
...
.method public final synthetic e()Lj$/util/stream/k1;
    .locals 2
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lj$/util/stream/i1;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic findAny()Lj$/util/n;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->H(Ljava/util/OptionalLong;)Lj$/util/n;
...
.method public final synthetic iterator()Lj$/util/z;
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Lj$/util/y;

    if-eqz v1, :cond_1

    check-cast v0, Lj$/util/y;

    iget-object v0, v0, Lj$/util/y;->a:Lj$/util/z;

    return-object v0

    :cond_1
    new-instance v1, Lj$/util/x;

    invoke-direct {v1, v0}, Lj$/util/x;-><init>(Ljava/util/PrimitiveIterator$OfLong;)V
...
.method public final synthetic k()Lj$/util/stream/b0;
    .locals 2
...
.method public final synthetic limit(J)Lj$/util/stream/k1;
    .locals 1
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Lj$/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/u6;->f(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic parallel()Lj$/util/stream/k1;
    .locals 1
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Lj$/util/stream/k1;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/n;
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->H(Ljava/util/OptionalLong;)Lj$/util/n;
...
.method public final synthetic sequential()Lj$/util/stream/k1;
    .locals 1
...
.method public final synthetic skip(J)Lj$/util/stream/k1;
    .locals 1
...
.method public final synthetic sorted()Lj$/util/stream/k1;
    .locals 1
...
.method public final synthetic spliterator()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/o0;->a(Ljava/util/Spliterator;)Lj$/util/Spliterator;
...
.method public final synthetic spliterator()Lj$/util/k0;
    .locals 1
    ...
    invoke-static {v0}, Lj$/util/i0;->a(Ljava/util/Spliterator$OfLong;)Lj$/util/k0;
