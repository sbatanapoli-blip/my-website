...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p2, v1, v2}, Landroid/support/v4/media/session/d0;->j(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroid/support/v4/media/session/d0;

    move-result-object p2

    const/4 v0, 0x5

    invoke-virtual {p2, v0}, Landroid/support/v4/media/session/d0;->f(I)Landroid/graphics/drawable/Drawable;
...
.method public final c(Lq/m;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lq/m;
    ...
    invoke-virtual {v1}, Lq/k;->n()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Lq/m;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Lq/m;->h:C
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lq/m;

    iget-object v1, v0, Lq/m;->n:Lq/k;
    ...
    iget-char v0, v0, Lq/m;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Lq/m;->h:C
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lq/m;

    iget-object v5, v1, Lq/m;->n:Lq/k;

    iget-object v6, v5, Lq/k;->a:Landroid/content/Context;

    invoke-virtual {v5}, Lq/k;->n()Z

    move-result v7

    if-eqz v7, :cond_6

    iget-char v7, v1, Lq/m;->j:C

    goto :goto_6

    :cond_6
    iget-char v7, v1, Lq/m;->h:C
    ...
    invoke-static {v1, v6, v5, v9}, Lq/m;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v1, v4, v5, v9}, Lq/m;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v1, v5, v4, v9}, Lq/m;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v1, v2, v4, v9}, Lq/m;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    iget-object p1, p1, Lq/m;->q:Ljava/lang/CharSequence;
...
.method public setCheckable(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lq/m;
