...
.method private parseHdrlBody(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    iget-object p1, p1, Landroidx/media3/extractor/avi/ListChunk;->children:Lp5/q0;

    const/4 v1, 0x0

    invoke-virtual {p1, v1}, Lp5/q0;->v(I)Lp5/o0;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p1}, Lp5/a;->hasNext()Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {p1}, Lp5/a;->next()Ljava/lang/Object;
