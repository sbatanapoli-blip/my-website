...
# static fields
.field private static final COMMA_JOINER:Lo5/e;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lo5/e;-><init>(Ljava/lang/String;)V

    sput-object v0, Landroidx/media3/exoplayer/upstream/CmcdData;->COMMA_JOINER:Lo5/e;
...
.method public static removeFromDataSpec(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/DataSpec;
    ...
    invoke-direct {v0, v5}, Lp5/t0;-><init>(I)V
    ...
    invoke-virtual {v0, v7, v6}, Lp5/t0;->b(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public addToDataSpec(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/DataSpec;
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdObject;->populateCmcdDataMap(Lp5/r;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest;->populateCmcdDataMap(Lp5/r;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdSession;->populateCmcdDataMap(Lp5/r;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus;->populateCmcdDataMap(Lp5/r;)V

    iget v1, p0, Landroidx/media3/exoplayer/upstream/CmcdData;->dataTransmissionMode:I

    if-nez v1, :cond_2

    new-instance v1, Lp5/t0;

    const/4 v2, 0x4

    invoke-direct {v1, v2}, Lp5/t0;-><init>(I)V

    iget-object v2, v0, Lp5/q;->c:Ljava/util/Set;
    ...
    iput-object v2, v0, Lp5/q;->c:Ljava/util/Set;
    ...
    invoke-virtual {v0, v3}, Lp5/b;->get(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v4

    invoke-static {v4}, Ljava/util/Collections;->sort(Ljava/util/List;)V

    sget-object v5, Landroidx/media3/exoplayer/upstream/CmcdData;->COMMA_JOINER:Lo5/e;

    invoke-virtual {v5, v4}, Lo5/e;->b(Ljava/util/List;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1, v3, v4}, Lp5/t0;->b(Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_1
    invoke-virtual {v1}, Lp5/t0;->a()Lp5/x1;
    ...
    invoke-virtual {v0}, Lp5/b;->a()Ljava/util/Map;
    ...
    sget-object v2, Landroidx/media3/exoplayer/upstream/CmcdData;->COMMA_JOINER:Lo5/e;

    invoke-virtual {v2, v1}, Lo5/e;->b(Ljava/util/List;)Ljava/lang/String;
