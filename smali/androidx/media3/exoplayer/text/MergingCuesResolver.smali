...
# static fields
.field private static final CUES_DISPLAY_PRIORITY_COMPARATOR:Lp5/p1;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v3, v1, v0}, Lp5/t;-><init>(Lo5/d;Lp5/p1;)V

    new-instance v0, Lp5/e0;

    invoke-direct {v0, v2, v3}, Lp5/e0;-><init>(Lp5/t;Lp5/t;)V

    sput-object v0, Landroidx/media3/exoplayer/text/MergingCuesResolver;->CUES_DISPLAY_PRIORITY_COMPARATOR:Lp5/p1;
...
.method public getCuesAtTimeUs(J)Lp5/q0;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    :cond_3
    :goto_1
    sget-object p1, Landroidx/media3/exoplayer/text/MergingCuesResolver;->CUES_DISPLAY_PRIORITY_COMPARATOR:Lp5/p1;

    invoke-static {p1, v0}, Lp5/q0;->z(Ljava/util/Comparator;Ljava/util/List;)Lp5/s1;
    ...
    :goto_2
    iget v0, p1, Lp5/s1;->e:I

    if-ge v1, v0, :cond_4

    invoke-virtual {p1, v1}, Lp5/s1;->get(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroidx/media3/extractor/text/CuesWithTiming;

    iget-object v0, v0, Landroidx/media3/extractor/text/CuesWithTiming;->cues:Lp5/q0;

    invoke-virtual {p2, v0}, Lp5/k0;->c(Ljava/lang/Iterable;)V
