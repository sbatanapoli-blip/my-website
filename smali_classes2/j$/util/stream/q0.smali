...
# instance fields
.field public final a:Lj$/util/stream/u3;
...
.field public final e:Lj$/util/stream/p0;

.field public final f:Lj$/util/stream/q0;

.field public g:Lj$/util/stream/f2;


# direct methods
.method public constructor <init>(Lj$/util/stream/q0;Lj$/util/Spliterator;Lj$/util/stream/q0;)V
    .locals 2
    ...
    .line 389
    iget-object v0, p1, Lj$/util/stream/q0;->a:Lj$/util/stream/u3;

    iput-object v0, p0, Lj$/util/stream/q0;->a:Lj$/util/stream/u3;

    .line 390
    iput-object p2, p0, Lj$/util/stream/q0;->b:Lj$/util/Spliterator;
    ...
    .line 393
    iget-object p1, p1, Lj$/util/stream/q0;->e:Lj$/util/stream/p0;

    iput-object p1, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/p0;
...
.method public constructor <init>(Lj$/util/stream/u3;Lj$/util/Spliterator;Lj$/util/stream/p0;)V
    .locals 2
    ...
    .line 376
    iput-object p1, p0, Lj$/util/stream/q0;->a:Lj$/util/stream/u3;
    ...
    .line 381
    iput-object p3, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/p0;
...
.method public final compute()V
    ...
    .line 403
    iget-object v0, p0, Lj$/util/stream/q0;->b:Lj$/util/Spliterator;
    ...
    invoke-direct {v6, v4, v5, v7}, Lj$/util/stream/q0;-><init>(Lj$/util/stream/q0;Lj$/util/Spliterator;Lj$/util/stream/q0;)V

    .line 410
    new-instance v7, Lj$/util/stream/q0;

    invoke-direct {v7, v4, v0, v6}, Lj$/util/stream/q0;-><init>(Lj$/util/stream/q0;Lj$/util/Spliterator;Lj$/util/stream/q0;)V
    ...
    .line 476
    iget-object v2, v4, Lj$/util/stream/q0;->a:Lj$/util/stream/u3;

    .line 477
    invoke-virtual {v2, v0}, Lj$/util/stream/u3;->k0(Lj$/util/Spliterator;)J

    move-result-wide v5

    .line 476
    invoke-virtual {v2, v5, v6, v1}, Lj$/util/stream/u3;->A0(JLjava/util/function/IntFunction;)Lj$/util/stream/x1;
    ...
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/u3;->E0(Lj$/util/Spliterator;Lj$/util/stream/k5;)Lj$/util/stream/k5;

    invoke-interface {v1}, Lj$/util/stream/x1;->build()Lj$/util/stream/f2;

    move-result-object v0

    iput-object v0, v4, Lj$/util/stream/q0;->g:Lj$/util/stream/f2;

    const/4 v0, 0x0

    .line 480
    iput-object v0, v4, Lj$/util/stream/q0;->b:Lj$/util/Spliterator;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    .line 487
    iget-object p1, p0, Lj$/util/stream/q0;->g:Lj$/util/stream/f2;
    ...
    .line 489
    iget-object v1, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/p0;

    invoke-interface {p1, v1}, Lj$/util/stream/f2;->forEach(Ljava/util/function/Consumer;)V

    .line 490
    iput-object v0, p0, Lj$/util/stream/q0;->g:Lj$/util/stream/f2;

    goto :goto_0

    .line 492
    :cond_0
    iget-object p1, p0, Lj$/util/stream/q0;->b:Lj$/util/Spliterator;

    if-eqz p1, :cond_1

    .line 494
    iget-object v1, p0, Lj$/util/stream/q0;->a:Lj$/util/stream/u3;

    iget-object v2, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/p0;

    invoke-virtual {v1, p1, v2}, Lj$/util/stream/u3;->E0(Lj$/util/Spliterator;Lj$/util/stream/k5;)Lj$/util/stream/k5;

    .line 495
    iput-object v0, p0, Lj$/util/stream/q0;->b:Lj$/util/Spliterator;
