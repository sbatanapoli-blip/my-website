...
# virtual methods
.method public final B(Ljava/util/Map;Lj$/time/format/v;)Lj$/time/chrono/ChronoLocalDate;
    .locals 9
    ...
    .line 649
    sget-object p2, Lj$/time/j;->FEBRUARY:Lj$/time/j;
    ...
    :cond_3
    :goto_0
    invoke-virtual {p2, v2}, Lj$/time/j;->M(Z)I
...
.method public final D(Ljava/util/Map;Lj$/time/format/v;)Lj$/time/chrono/ChronoLocalDate;
    ...
    :cond_1
    invoke-static {v5, v6, v0, v1}, Lj$/com/android/tools/r8/a;->S(JJ)J
    ...
    invoke-static {p1, p2, v0, v1}, Lj$/time/chrono/a;->j(Ljava/util/Map;Lj$/time/temporal/a;J)V
    ...
    invoke-virtual {p2, v0, v1}, Lj$/time/temporal/a;->D(J)V
...
.method public final J(Lj$/time/Instant;Lj$/time/v;)Lj$/time/chrono/i;
    ...
    invoke-static {v0, v1, p1, p2}, Lj$/time/y;->o(JILj$/time/v;)Lj$/time/y;
...
.method public final w(Ljava/util/Map;Lj$/time/format/v;)V
    .locals 6
    ...
    .line 595
    invoke-static {p1, p2, v2, v3}, Lj$/time/chrono/a;->j(Ljava/util/Map;Lj$/time/temporal/a;J)V
...
.method public final z(Lj$/time/g;)Lj$/time/chrono/d;
    .locals 0
