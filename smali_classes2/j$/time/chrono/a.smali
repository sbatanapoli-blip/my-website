...
.method public static j(Ljava/util/Map;Lj$/time/temporal/a;J)V
    .locals 3
...
.method public static l(Lj$/time/chrono/l;Ljava/lang/String;)Lj$/time/chrono/l;
    .locals 2
...
.method public static o(Lj$/time/chrono/ChronoLocalDate;JJJ)Lj$/time/chrono/ChronoLocalDate;
    .locals 4
    ...
    .line 639
    invoke-static {p5, p6, p2, p3}, Lj$/com/android/tools/r8/a;->S(JJ)J
    ...
    .line 642
    invoke-static {p1}, Lj$/time/DayOfWeek;->L(I)Lj$/time/DayOfWeek;
    ...
    .line 642
    invoke-interface {p0, p2}, Lj$/time/chrono/ChronoLocalDate;->v(Lj$/time/temporal/m;)Lj$/time/chrono/ChronoLocalDate;
...
# virtual methods
.method public B(Ljava/util/Map;Lj$/time/format/v;)Lj$/time/chrono/ChronoLocalDate;
    .locals 7

    .line 536
    sget-object v0, Lj$/time/temporal/a;->YEAR:Lj$/time/temporal/a;

    invoke-interface {p0, v0}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    invoke-static {v3, v4, v5, v6}, Lj$/com/android/tools/r8/a;->S(JJ)J
    ...
    invoke-static {p1, p2, v5, v6}, Lj$/com/android/tools/r8/a;->S(JJ)J
    ...
    invoke-interface {p0, v1}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    invoke-interface {p0, v3}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    .line 549
    invoke-interface {p1, p2}, Lj$/time/chrono/ChronoLocalDate;->v(Lj$/time/temporal/m;)Lj$/time/chrono/ChronoLocalDate;
...
.method public D(Ljava/util/Map;Lj$/time/format/v;)Lj$/time/chrono/ChronoLocalDate;
    .locals 9
    ...
    .line 502
    sget-object v4, Lj$/time/format/v;->LENIENT:Lj$/time/format/v;
    ...
    .line 508
    invoke-interface {p0, v2}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    invoke-interface {p0, p2}, Lj$/time/chrono/l;->s(I)Lj$/time/chrono/m;
    ...
    invoke-interface {p0, p2, v4}, Lj$/time/chrono/l;->t(Lj$/time/chrono/m;I)I

    move-result p2

    int-to-long v1, p2

    invoke-static {p1, v0, v1, v2}, Lj$/time/chrono/a;->j(Ljava/util/Map;Lj$/time/temporal/a;J)V
    ...
    .line 513
    invoke-interface {p0, p2, v5}, Lj$/time/chrono/l;->n(II)Lj$/time/chrono/ChronoLocalDate;

    move-result-object p2

    .line 514
    invoke-interface {p2}, Lj$/time/chrono/ChronoLocalDate;->E()Lj$/time/chrono/m;
    ...
    invoke-static {p1, v2, v0, v1}, Lj$/time/chrono/a;->j(Ljava/util/Map;Lj$/time/temporal/a;J)V

    goto :goto_1

    .line 515
    :cond_2
    sget-object v3, Lj$/time/format/v;->STRICT:Lj$/time/format/v;
    ...
    .line 520
    :cond_3
    invoke-interface {p0}, Lj$/time/chrono/l;->r()Ljava/util/List;
    ...
    .line 530
    invoke-interface {p0, p2}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
...
.method public I(Ljava/util/Map;Lj$/time/format/v;)Lj$/time/chrono/ChronoLocalDate;
    .locals 19
    ...
    invoke-interface {v0, v1, v2}, Lj$/time/chrono/l;->h(J)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 444
    :cond_0
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->w(Ljava/util/Map;Lj$/time/format/v;)V

    .line 447
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->D(Ljava/util/Map;Lj$/time/format/v;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 456
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->B(Ljava/util/Map;Lj$/time/format/v;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 566
    invoke-interface {v0, v3}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    invoke-static {v10, v11, v7, v8}, Lj$/com/android/tools/r8/a;->S(JJ)J
    ...
    invoke-static {v4, v5, v7, v8}, Lj$/com/android/tools/r8/a;->S(JJ)J
    ...
    invoke-static {v1, v2, v7, v8}, Lj$/com/android/tools/r8/a;->S(JJ)J

    move-result-wide v1

    .line 571
    invoke-interface {v0, v3, v6, v6}, Lj$/time/chrono/l;->G(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 573
    :cond_3
    invoke-interface {v0, v4}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    .line 574
    invoke-interface {v0, v5}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    .line 575
    invoke-interface {v0, v9}, Lj$/time/chrono/l;->q(Lj$/time/temporal/a;)Lj$/time/temporal/t;
    ...
    .line 576
    invoke-interface {v0, v3, v7, v6}, Lj$/time/chrono/l;->G(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v3, v5, v6, v1}, Lj$/time/chrono/ChronoLocalDate;->d(JLj$/time/temporal/r;)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v3, v5, v6, v8}, Lj$/time/chrono/ChronoLocalDate;->d(JLj$/time/temporal/r;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 594
    invoke-interface {v3, v5}, Lj$/time/chrono/ChronoLocalDate;->v(Lj$/time/temporal/m;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 557
    sget-object v5, Lj$/time/format/v;->LENIENT:Lj$/time/format/v;
    ...
    .line 559
    invoke-interface {v0, v3, v6}, Lj$/time/chrono/l;->n(II)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 562
    invoke-interface {v0, v3, v1}, Lj$/time/chrono/l;->n(II)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 603
    sget-object v11, Lj$/time/format/v;->LENIENT:Lj$/time/format/v;
    ...
    invoke-static {v2, v3, v7, v8}, Lj$/com/android/tools/r8/a;->S(JJ)J
    ...
    .line 606
    invoke-interface {v0, v9, v6}, Lj$/time/chrono/l;->n(II)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 611
    sget-object v4, Lj$/time/format/v;->STRICT:Lj$/time/format/v;
    ...
    .line 626
    invoke-interface {v4, v5}, Lj$/time/chrono/ChronoLocalDate;->v(Lj$/time/temporal/m;)Lj$/time/chrono/ChronoLocalDate;
...
.method public abstract synthetic k()Lj$/time/chrono/ChronoLocalDate;
.end method
...
.method public w(Ljava/util/Map;Lj$/time/format/v;)V
    .locals 5
    ...
    .line 490
    :cond_0
    invoke-virtual {p0}, Lj$/time/chrono/a;->k()Lj$/time/chrono/ChronoLocalDate;
...
.method public z(Lj$/time/g;)Lj$/time/chrono/d;
    .locals 4

    .line 477
    :try_start_0
    invoke-interface {p0, p1}, Lj$/time/chrono/l;->y(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v0, p1}, Lj$/time/chrono/ChronoLocalDate;->C(Lj$/time/LocalTime;)Lj$/time/chrono/d;
