...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v3, v6}, Ln5/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;

    move-result-object p1

    invoke-direct {p0, p1, p2, v3}, Lr/q;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v2, Ll4/a;->m:[I

    move-object v1, p2

    invoke-static/range {v0 .. v5}, Lc5/f0;->h(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v2, v5}, Lc5/f0;->j(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v2, p2, v7}, Lf5/b;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, p2, v7}, Lf5/b;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1, v3, v6}, Li5/k;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)Li5/j;
    ...
    invoke-direct {v1, p0, v0}, Lt4/c;-><init>(Lcom/google/android/material/button/MaterialButton;Li5/k;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->e:Lt4/c;

    invoke-virtual {p2, v7, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v0

    iput v0, v1, Lt4/c;->c:I
    ...
    iput v0, v1, Lt4/c;->g:I

    iget-object v2, v1, Lt4/c;->b:Li5/k;
    ...
    invoke-virtual {v2, v0}, Li5/j;->b(F)V

    invoke-virtual {v2}, Li5/j;->a()Li5/k;

    move-result-object v0

    invoke-virtual {v1, v0}, Lt4/c;->c(Li5/k;)V

    iput-boolean v7, v1, Lt4/c;->p:Z
    ...
    invoke-static {v0, v5}, Lc5/f0;->j(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iput-object v0, v1, Lt4/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v0, p2, v2}, Lf5/b;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, v1, Lt4/c;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v1, Lt4/c;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v1, Lt4/c;->l:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v7, v1, Lt4/c;->o:Z

    iget-object v5, v1, Lt4/c;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, v1, Lt4/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_1
    invoke-virtual {v1}, Lt4/c;->e()V

    :goto_0
    iget v5, v1, Lt4/c;->c:I
    ...
    iget v5, v1, Lt4/c;->d:I

    add-int/2addr v3, v5

    iget v1, v1, Lt4/c;->f:I

    add-int/2addr v4, v1

    invoke-static {p0, v0, v2, v3, v4}, Lw0/g0;->k(Landroid/view/View;IIII)V
...
.method public final a()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->e:Lt4/c;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lt4/c;->o:Z
...
.method public final b()V
    ...
    invoke-static {p0, v2, v0, v2, v2}, La1/r;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v2, v2, v0, v2}, La1/r;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v0, v2, v2, v2}, La1/r;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public final c(Z)V
    ...
    invoke-static {v2, v0}, Lo0/b;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_4
    invoke-static {p0}, La1/r;->a(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lt4/c;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Li5/k;
    ...
    iget-object v0, v0, Lt4/c;->b:Li5/k;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lt4/c;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lt4/c;->j:Landroid/content/res/ColorStateList;

    return-object v0

    :cond_0
    invoke-super {p0}, Lr/q;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lt4/c;->i:Landroid/graphics/PorterDuff$Mode;

    return-object v0

    :cond_0
    invoke-super {p0}, Lr/q;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Lt4/c;->b(Z)Li5/g;
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, Lr/q;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-super {p0, p1}, Lr/q;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public final onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Lr/q;->onLayout(ZIIII)V
    ...
    iget-object v0, p1, Lcom/google/android/material/button/MaterialButton;->e:Lt4/c;
    ...
    iget-object p2, v0, Lt4/c;->m:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_0

    iget p3, v0, Lt4/c;->c:I

    iget v1, v0, Lt4/c;->e:I

    iget v2, v0, Lt4/c;->d:I
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lr/q;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->e:Lt4/c;

    iput-boolean v0, v1, Lt4/c;->o:Z

    iget-object v0, v1, Lt4/c;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v1, Lt4/c;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Lt4/c;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerRadius(I)V
    ...
    iget-boolean v1, v0, Lt4/c;->p:Z

    if-eqz v1, :cond_0

    iget v1, v0, Lt4/c;->g:I

    if-eq v1, p1, :cond_1

    :cond_0
    iput p1, v0, Lt4/c;->g:I

    const/4 v1, 0x1

    iput-boolean v1, v0, Lt4/c;->p:Z

    iget-object v1, v0, Lt4/c;->b:Li5/k;
    ...
    invoke-virtual {v0, p1}, Lt4/c;->c(Li5/k;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lt4/c;->d(II)V
...
.method public setInsetTop(I)V
    ...
    iget v1, v0, Lt4/c;->f:I

    invoke-virtual {v0, p1, v1}, Lt4/c;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lt4/a;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->g:Lt4/a;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->g:Lt4/a;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lt4/c;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Lt4/c;->l:Landroid/content/res/ColorStateList;

    if-eq v2, p1, :cond_1

    iput-object p1, v0, Lt4/c;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1}, Lg5/d;->b(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p1}, Lg5/b;->setTintList(Landroid/content/res/ColorStateList;)V
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, v0, Lt4/c;->n:Z

    invoke-virtual {v0}, Lt4/c;->f()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lt4/c;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lt4/c;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lt4/c;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lt4/c;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lt4/c;->b(Z)Li5/g;
    ...
    :cond_1
    invoke-super {p0, p1}, Lr/q;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lt4/c;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lt4/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_1
    invoke-super {p0, p1}, Lr/q;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
